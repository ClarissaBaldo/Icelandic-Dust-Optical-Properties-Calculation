...
# function to calculate the time average at different time resolution (here 2 min, original data as sec)
timeAverage_2min <- function(df) {
  ...
  # to calculate 2-min average split the data in #df = dim(df)[1]/120 of 120 rows
  ...
  # get the time sequence at 2 min
  df_TA$date <- seq(as.POSIXct(df_split[[1]][1,1]), as.POSIXct(df_split[[length(df_split)]][1,1]), by = "2 min")
  
  return(df_TA)
}

# function to calculate the standard deviation (SD) of the time average at different time resolution 
# (here 2 min, original data as sec)
...
timeAverage_2min_error <- function(df) {
  ...
  # to calculate 2-min SD split the data in #df = dim(df)[1]/120 of 120 rows
...
# import attenuation (ATTN at 370, 470, 520, 590, 660, 880, and 950 nm) data (2-min resolution)
...
# work on the data since filter sampling has started
Aet <- subset(Aet, Aet$date >= "2019-01-21 11:07:00")

# ensure that the time serie of the data is complete and every 2 min
df = Aet
...
plot(Aet$date, Aet$ATTN.370,
     main = bquote(bold("Attenuation - ATTN"*(lambda))),
     xlab = "Time during the experiment",
     ylab = "ATTN (%)", pch = 20, col = "#00bfff")
points(Aet$date, Aet$ATTN.470, col = "#189ed8", pch = 20)
points(Aet$date, Aet$ATTN.520, col = "#1c7fb1", pch = 20)
points(Aet$date, Aet$ATTN.590, col = "#19618b", pch = 20)
points(Aet$date, Aet$ATTN.660, col = "#134467", pch = 20)
points(Aet$date, Aet$ATTN.880, col = "#0a2a44", pch = 20)
points(Aet$date, Aet$ATTN.950, col = "#001224", pch = 20)

legend("topright", inset =.02, box.lty = 0,
       legend = c("370 nm", "470 nm", "520 nm", "590 nm", "660 nm", "880 nm","950 nm"),
       pch = c(20,20,20,20,20,20,20),
       col = c("#00bfff","#189ed8","#1c7fb1", "#19618b", "#134467", "#0a2a44", "#001224"))

#############################################################################################################
# calculate the attenuation coefficient: BATTN = [dATTN/dt]*A/V
#############################################################################################################

# from the original data select the column with attenuation data 
...
# (to convert from m^-1 into Mm^-1 multiply by 10^6)
...
#############################################################################################################
# calculate the measurement average ATTN to match BATTN data
#############################################################################################################

# build a function to calculate measurement average for each time interval
calculate_measurement_average <- function(df) {
  # create an empty df
  # calculating the averge for each time interval, nrow of the output will be equal to nrow(df) -1
...
# bind ATTN and BATTN dfs

# ensure the date column from the B_ATTN df is removed
...
# tidy up the data - drop the data after 14:00 
...
plot(Aet_TA$date, Aet_TA$BATTN_370,
     main = bquote(bold("Attenuation coefficient -"~beta[ATTN](lambda))),
     xlab = "Time during the experiment",
     ylab = bquote(beta[ATTN]~(m^-1)),
     ylim = c(0,0.001), pch = 20, col = "#00bfff")
points(Aet_TA$date, Aet_TA$BATTN_470, col = "#189ed8", pch = 20)
points(Aet_TA$date, Aet_TA$BATTN_520, col = "#1c7fb1", pch = 20)
points(Aet_TA$date, Aet_TA$BATTN_590, col = "#19618b", pch = 20)
points(Aet_TA$date, Aet_TA$BATTN_660, col = "#134467", pch = 20)
points(Aet_TA$date, Aet_TA$BATTN_880, col = "#0a2a44", pch = 20)
points(Aet_TA$date, Aet_TA$BATTN_950, col = "#001224", pch = 20)
legend("topright", inset =.02, box.lty = 0,
       legend = c("370 nm", "470 nm", "520 nm", "590 nm", "660 nm", "880 nm","950 nm"),
       pch = c(20,20,20,20,20,20,20),
       col = c("#00bfff","#189ed8","#1c7fb1", "#19618b", "#134467", "#0a2a44", "#001224"))
...
# get only date and the columns with the relevant measurements (Scattering coefficients - Bsca at 450, 550, and 700 nm)
...
for (i in 2:length(Nep_TA_error_step1)) {
  for (j in 1:nrow(Nep_TA_error_step1)-1) {
    Nep_TA_error_step2[j,i] <- 1/2*(Nep_TA_error_step1[j,i] + Nep_TA_error_step1[j+1,i]) # average the two SD
  }
}
...
# add to the error further 5% uncertainty due to gas calibration - step 3
...
# add the gas calib error to the uncertainty in step2 
...
plot(Nep_TA$date, Nep_TA$Scatt_blue,
     main = bquote(bold("Scattering coefficient -"~beta[sca](lambda))),
     xlab = "Time during the experiment",
     ylab = bquote(beta[sca]~(m^-1)),
     ylim = c(0,0.002), 
     col="#189ed8", pch = 20)
points(Nep_TA$date, Nep_TA$Scatt_green, col="#1c7fb1", pch = 20)
points(Nep_TA$date, Nep_TA$Scatt_red, col="#19618b", pch = 20)

arrows(x0=Nep_TA$date, y0=Nep_TA$Scatt_blue - Nep_TA_error_step3$Scatt_blue, 
       x1=Nep_TA$date, y1=Nep_TA$Scatt_blue + Nep_TA_error_step3$Scatt_blue, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=Nep_TA$date, y0=Nep_TA$Scatt_green - Nep_TA_error_step3$Scatt_green, 
       x1=Nep_TA$date, y1=Nep_TA$Scatt_green + Nep_TA_error_step3$Scatt_green, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=Nep_TA$date, y0=Nep_TA$Scatt_red - Nep_TA_error_step3$Scatt_red, 
       x1=Nep_TA$date, y1=Nep_TA$Scatt_red + Nep_TA_error_step3$Scatt_red, code=3, angle=90, length=0.1, col="#19618b", lwd=1)

legend("topright", inset =.02, box.lty = 0,
       legend = c("450 nm", "550 nm", "700 nm"),
       pch = c(20,20,20),
       col = c("#189ed8","#1c7fb1", "#19618b"))
...
# interpolate also truncation uncertainty using a linear model
...
############################################################################################################
# plot Nep data corrected
############################################################################################################

plot(Nep_TA$date, Nep_TA_corrected$Scatt_blue,
     main = bquote(bold(beta[sca]~"corrected for truncation")),
     xlab = "Time during the experiment",
     ylab = bquote(~beta[sca]~(m^-1)),
     ylim = c(0,0.002), col="#189ed8", pch = 20)
points(Nep_TA$date, Nep_TA_corrected$Scatt_green, col="#1c7fb1", pch = 20)
points(Nep_TA$date, Nep_TA_corrected$Scatt_red, col="#19618b", pch = 20)
arrows(x0=Nep_TA$date, y0=Nep_TA_corrected$Scatt_blue - Nep_TA_error_step4$Scatt_blue, 
       x1=Nep_TA$date, y1=Nep_TA_corrected$Scatt_blue + Nep_TA_error_step4$Scatt_blue, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=Nep_TA$date, y0=Nep_TA_corrected$Scatt_green - Nep_TA_error_step4$Scatt_green, 
       x1=Nep_TA$date, y1=Nep_TA_corrected$Scatt_green + Nep_TA_error_step4$Scatt_green, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=Nep_TA$date, y0=Nep_TA_corrected$Scatt_red - Nep_TA_error_step4$Scatt_red, 
       x1=Nep_TA$date, y1=Nep_TA_corrected$Scatt_red + Nep_TA_error_step4$Scatt_red, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
...
# Method from Collaud Coen et al. (2010) (doi: 10.5194/amt-3-457-2010) and Di Biagio et al. (2019) (doi: 10.5194/acp-19-15503-2019)

# SE_correction(WL) =A^(d-1)*c*WL^(-AE*(d-1))

# WL = wavelength
# AE = Angstrom exponent
# Bsca(WL) = A*WL^AE (power-law fitting)

# c = 3.29*10^-4 from Collaud Coen et al. 2010
# d = 0.564 from Collaud Coen et al. 2010
...
# define the starting a and b values for the power-law fitting
test_ab <- list()
a <- list()
b <- list()
...
# fit the data using power-law fitting
model_powerLaw <- list()
...
#############################################################################################################
# extrapolate Bsca values at the Aet WL (370, 470, 520, 590, 660, 880, 950 nm)
#############################################################################################################

# the new WL class must be as df
...
predict_Bsca <- function(new_WL) {
  # for each row (date-time) is applied a specific power-law fit
...
############################################################################################################
# plot Bsca fitted data
############################################################################################################

par(mfrow= c(1,1))

plot(Bsca_fitted_df$date, Bsca_fitted_df$Bsca_370,
     main = bquote(bold(beta[sca]~"predicted")),
     xlab = "Time during the experiment",
     ylab = bquote(beta[sca]~(m^-1)),
     ylim = c(0,0.002), col="#00bfff", pch = 20)
points(Bsca_fitted_df$date, Bsca_fitted_df$Bsca_470, col="#189ed8", pch = 20)
points(Bsca_fitted_df$date, Bsca_fitted_df$Bsca_520, col="#1c7fb1", pch = 20)
points(Bsca_fitted_df$date, Bsca_fitted_df$Bsca_590, col="#19618b", pch = 20)
points(Bsca_fitted_df$date, Bsca_fitted_df$Bsca_660, col="#134467", pch = 20)
points(Bsca_fitted_df$date, Bsca_fitted_df$Bsca_880, col="#0a2a44", pch = 20)
points(Bsca_fitted_df$date, Bsca_fitted_df$Bsca_950, col="#001224", pch = 20)

arrows(x0=Bsca_fitted_df$date, y0=Bsca_fitted_df$Bsca_370 - Nep_TA_error_step5$Bsca_370, 
       x1=Bsca_fitted_df$date, y1=Bsca_fitted_df$Bsca_370 + Nep_TA_error_step5$Bsca_370, code=3, angle=90, length=0.1, col="#00bfff", lwd=1)
arrows(x0=Bsca_fitted_df$date, y0=Bsca_fitted_df$Bsca_470 - Nep_TA_error_step5$Bsca_470, 
       x1=Bsca_fitted_df$date, y1=Bsca_fitted_df$Bsca_470 + Nep_TA_error_step5$Bsca_470, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=Bsca_fitted_df$date, y0=Bsca_fitted_df$Bsca_520 - Nep_TA_error_step5$Bsca_520, 
       x1=Bsca_fitted_df$date, y1=Bsca_fitted_df$Bsca_520 + Nep_TA_error_step5$Bsca_520, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=Bsca_fitted_df$date, y0=Bsca_fitted_df$Bsca_590 - Nep_TA_error_step5$Bsca_590, 
       x1=Bsca_fitted_df$date, y1=Bsca_fitted_df$Bsca_590 + Nep_TA_error_step5$Bsca_590, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
arrows(x0=Bsca_fitted_df$date, y0=Bsca_fitted_df$Bsca_660 - Nep_TA_error_step5$Bsca_660, 
       x1=Bsca_fitted_df$date, y1=Bsca_fitted_df$Bsca_660 + Nep_TA_error_step5$Bsca_660, code=3, angle=90, length=0.1, col="#134467", lwd=1)
arrows(x0=Bsca_fitted_df$date, y0=Bsca_fitted_df$Bsca_880 - Nep_TA_error_step5$Bsca_880, 
       x1=Bsca_fitted_df$date, y1=Bsca_fitted_df$Bsca_880 + Nep_TA_error_step5$Bsca_880, code=3, angle=90, length=0.1, col="#0a2a44", lwd=1)
arrows(x0=Bsca_fitted_df$date, y0=Bsca_fitted_df$Bsca_950 - Nep_TA_error_step5$Bsca_950, 
       x1=Bsca_fitted_df$date, y1=Bsca_fitted_df$Bsca_950 + Nep_TA_error_step5$Bsca_950, code=3, angle=90, length=0.1, col="#001224", lwd=1)
...
#############################################################################################################
# calculate SE_correction at 370, 470, 520, 590, 660, 880, 950 nm
#############################################################################################################
...
# calculate SE_correction error (dSE) 
# dA = A_error
# dAE = AE_error
...
plot(SE_correction_df$date, SE_correction_df$SE_corr_370,
     ...
     ylim = c(0,0.04),
     xlab = "Time during the experiment",
     main = bquote(bold("Scattering effect correction -"~alpha(lambda))),
     col="#00bfff", pch = 20)

points(SE_correction_df$date, SE_correction_df$SE_corr_470, col="#189ed8", pch = 20)
points(SE_correction_df$date, SE_correction_df$SE_corr_520, col="#1c7fb1", pch = 20)
points(SE_correction_df$date, SE_correction_df$SE_corr_590, col="#19618b", pch = 20)
points(SE_correction_df$date, SE_correction_df$SE_corr_660, col="#134467", pch = 20)
points(SE_correction_df$date, SE_correction_df$SE_corr_880, col="#0a2a44", pch = 20)
points(SE_correction_df$date, SE_correction_df$SE_corr_950, col="#001224", pch = 20)

arrows(x0=SE_correction_df$date, y0=SE_correction_df$SE_corr_370 - SE_correction_df_error$SE_corr_370, 
       x1=SE_correction_df$date, y1=SE_correction_df$SE_corr_370 + SE_correction_df_error$SE_corr_370, code=3, angle=90, length=0.1, col="#00bfff", lwd=1)
arrows(x0=SE_correction_df$date, y0=SE_correction_df$SE_corr_470 - SE_correction_df_error$SE_corr_470, 
       x1=SE_correction_df$date, y1=SE_correction_df$SE_corr_470 + SE_correction_df_error$SE_corr_470, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=SE_correction_df$date, y0=SE_correction_df$SE_corr_520 - SE_correction_df_error$SE_corr_520, 
       x1=SE_correction_df$date, y1=SE_correction_df$SE_corr_520 + SE_correction_df_error$SE_corr_520, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=SE_correction_df$date, y0=SE_correction_df$SE_corr_590 - SE_correction_df_error$SE_corr_590, 
       x1=SE_correction_df$date, y1=SE_correction_df$SE_corr_590 + SE_correction_df_error$SE_corr_590, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
arrows(x0=SE_correction_df$date, y0=SE_correction_df$SE_corr_660 - SE_correction_df_error$SE_corr_660, 
       x1=SE_correction_df$date, y1=SE_correction_df$SE_corr_660 + SE_correction_df_error$SE_corr_660, code=3, angle=90, length=0.1, col="#134467", lwd=1)
arrows(x0=SE_correction_df$date, y0=SE_correction_df$SE_corr_880 - SE_correction_df_error$SE_corr_880, 
       x1=SE_correction_df$date, y1=SE_correction_df$SE_corr_880 + SE_correction_df_error$SE_corr_880, code=3, angle=90, length=0.1, col="#0a2a44", lwd=1)
arrows(x0=SE_correction_df$date, y0=SE_correction_df$SE_corr_950 - SE_correction_df_error$SE_corr_950, 
       x1=SE_correction_df$date, y1=SE_correction_df$SE_corr_950 + SE_correction_df_error$SE_corr_950, code=3, angle=90, length=0.1, col="#001224", lwd=1)
...
# where a = 0.74 from Collaud Coen et al. 2010

# calculate LE_correction at 370, 470, 520, 590, 660, 880, 950 nm
...
# Babs is from Aet (you can use BATTN - SE_corr, the scattering correction)
...
# calculate Babs(minus SE_corr) = BATTN(WL) - SE_corr(WL)*Bsca(WL) at 370, 470, 520, 590, 660, 880, 950 nm
...
plot(Babs_minus_SE_df$date, Babs_minus_SE_df$Babs_minus_SE_370,
     ...
     xlab = "Time during the experiment",
     ylim = c(0,0.0012),
     main = bquote(bold(beta[abs](lambda)*"*")),
     col="#00bfff", pch = 20)
points(Babs_minus_SE_df$date, Babs_minus_SE_df$Babs_minus_SE_470, col="#189ed8", pch = 20)
points(Babs_minus_SE_df$date, Babs_minus_SE_df$Babs_minus_SE_520, col="#1c7fb1", pch = 20)
points(Babs_minus_SE_df$date, Babs_minus_SE_df$Babs_minus_SE_590, col="#19618b", pch = 20)
points(Babs_minus_SE_df$date, Babs_minus_SE_df$Babs_minus_SE_660, col="#134467", pch = 20)
points(Babs_minus_SE_df$date, Babs_minus_SE_df$Babs_minus_SE_880, col="#0a2a44", pch = 20)
points(Babs_minus_SE_df$date, Babs_minus_SE_df$Babs_minus_SE_950, col="#001224", pch = 20)

arrows(x0=Babs_minus_SE_df$date, y0=Babs_minus_SE_df$Babs_minus_SE_370 - Babs_minus_SE_df_error$Babs_minus_SE_370, 
       x1=Babs_minus_SE_df$date, y1=Babs_minus_SE_df$Babs_minus_SE_370 + Babs_minus_SE_df_error$Babs_minus_SE_370, code=3, angle=90, length=0.1, col="#00bfff", lwd=1)
arrows(x0=Babs_minus_SE_df$date, y0=Babs_minus_SE_df$Babs_minus_SE_470 - Babs_minus_SE_df_error$Babs_minus_SE_470, 
       x1=Babs_minus_SE_df$date, y1=Babs_minus_SE_df$Babs_minus_SE_470 + Babs_minus_SE_df_error$Babs_minus_SE_470, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=Babs_minus_SE_df$date, y0=Babs_minus_SE_df$Babs_minus_SE_520 - Babs_minus_SE_df_error$Babs_minus_SE_520, 
       x1=Babs_minus_SE_df$date, y1=Babs_minus_SE_df$Babs_minus_SE_520 + Babs_minus_SE_df_error$Babs_minus_SE_520, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=Babs_minus_SE_df$date, y0=Babs_minus_SE_df$Babs_minus_SE_590 - Babs_minus_SE_df_error$Babs_minus_SE_590, 
       x1=Babs_minus_SE_df$date, y1=Babs_minus_SE_df$Babs_minus_SE_590 + Babs_minus_SE_df_error$Babs_minus_SE_590, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
arrows(x0=Babs_minus_SE_df$date, y0=Babs_minus_SE_df$Babs_minus_SE_660 - Babs_minus_SE_df_error$Babs_minus_SE_660, 
       x1=Babs_minus_SE_df$date, y1=Babs_minus_SE_df$Babs_minus_SE_660 + Babs_minus_SE_df_error$Babs_minus_SE_660, code=3, angle=90, length=0.1, col="#134467", lwd=1)
arrows(x0=Babs_minus_SE_df$date, y0=Babs_minus_SE_df$Babs_minus_SE_880 - Babs_minus_SE_df_error$Babs_minus_SE_880, 
       x1=Babs_minus_SE_df$date, y1=Babs_minus_SE_df$Babs_minus_SE_880 + Babs_minus_SE_df_error$Babs_minus_SE_880, code=3, angle=90, length=0.1, col="#0a2a44", lwd=1)
arrows(x0=Babs_minus_SE_df$date, y0=Babs_minus_SE_df$Babs_minus_SE_950 - Babs_minus_SE_df_error$Babs_minus_SE_950, 
       x1=Babs_minus_SE_df$date, y1=Babs_minus_SE_df$Babs_minus_SE_950 + Babs_minus_SE_df_error$Babs_minus_SE_950, code=3, angle=90, length=0.1, col="#001224", lwd=1)
...
# calculate SSA at 370, 470, 520, 590, 660, 880, 950 nm
SSA_list <- list()
...
plot(SSA_df$date, SSA_df$SSA_370,
     ...
     xlab = "Time during the experiment",
     ylim = c(0,1.08),
     main = bquote(bold("Single scattering albedo - SSA"*(lambda))),
     col="#00bfff", pch = 20)
points(SSA_df$date, SSA_df$SSA_470, col="#189ed8", pch = 20)
points(SSA_df$date, SSA_df$SSA_520, col="#1c7fb1", pch = 20)
points(SSA_df$date, SSA_df$SSA_590, col="#19618b", pch = 20)
points(SSA_df$date, SSA_df$SSA_660, col="#134467", pch = 20)
points(SSA_df$date, SSA_df$SSA_880, col="#0a2a44", pch = 20)
points(SSA_df$date, SSA_df$SSA_950, col="#001224", pch = 20)

arrows(x0=SSA_df$date, y0=SSA_df$SSA_370 - SSA_df_error$SSA_370, 
       x1=SSA_df$date, y1=SSA_df$SSA_370 + SSA_df_error$SSA_370, code=3, angle=90, length=0.1, col="#00bfff", lwd=1)
arrows(x0=SSA_df$date, y0=SSA_df$SSA_470 - SSA_df_error$SSA_470, 
       x1=SSA_df$date, y1=SSA_df$SSA_470 + SSA_df_error$SSA_470, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=SSA_df$date, y0=SSA_df$SSA_520 - SSA_df_error$SSA_520, 
       x1=SSA_df$date, y1=SSA_df$SSA_520 + SSA_df_error$SSA_520, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=SSA_df$date, y0=SSA_df$SSA_590 - SSA_df_error$SSA_590, 
       x1=SSA_df$date, y1=SSA_df$SSA_590 + SSA_df_error$SSA_590, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
arrows(x0=SSA_df$date, y0=SSA_df$SSA_660 - SSA_df_error$SSA_660, 
       x1=SSA_df$date, y1=SSA_df$SSA_660 + SSA_df_error$SSA_660, code=3, angle=90, length=0.1, col="#134467", lwd=1)
arrows(x0=SSA_df$date, y0=SSA_df$SSA_880 - SSA_df_error$SSA_880, 
       x1=SSA_df$date, y1=SSA_df$SSA_880 + SSA_df_error$SSA_880, code=3, angle=90, length=0.1, col="#0a2a44", lwd=1)
arrows(x0=SSA_df$date, y0=SSA_df$SSA_950 - SSA_df_error$SSA_950, 
       x1=SSA_df$date, y1=SSA_df$SSA_950 + SSA_df_error$SSA_950, code=3, angle=90, length=0.1, col="#001224", lwd=1)
...
plot(f_WL_df$date, f_WL_df$f_WL_370,
     ylab = bquote(f),
     xlab = "Time during the experiment",
     main = bquote(bold(f(lambda))),
     col="#00bfff", pch = 20, ylim = c(0,1.5))
points(f_WL_df$date, f_WL_df$f_WL_470, col="#189ed8", pch = 20)
points(f_WL_df$date, f_WL_df$f_WL_520, col="#1c7fb1", pch = 20)
points(f_WL_df$date, f_WL_df$f_WL_590, col="#19618b", pch = 20)
points(f_WL_df$date, f_WL_df$f_WL_660, col="#134467", pch = 20)
points(f_WL_df$date, f_WL_df$f_WL_880, col="#0a2a44", pch = 20)
points(f_WL_df$date, f_WL_df$f_WL_950, col="#001224", pch = 20)

arrows(x0=f_WL_df$date, y0=f_WL_df$f_WL_370 - f_WL_df_error$f_WL_370, 
       x1=f_WL_df$date, y1=f_WL_df$f_WL_370 + f_WL_df_error$f_WL_370, code=3, angle=90, length=0.1, col="#00bfff", lwd=1)
arrows(x0=f_WL_df$date, y0=f_WL_df$f_WL_470 - f_WL_df_error$f_WL_470, 
       x1=f_WL_df$date, y1=f_WL_df$f_WL_470 + f_WL_df_error$f_WL_470, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=f_WL_df$date, y0=f_WL_df$f_WL_520 - f_WL_df_error$f_WL_520, 
       x1=f_WL_df$date, y1=f_WL_df$f_WL_520 + f_WL_df_error$f_WL_520, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=f_WL_df$date, y0=f_WL_df$f_WL_590 - f_WL_df_error$f_WL_590, 
       x1=f_WL_df$date, y1=f_WL_df$f_WL_590 + f_WL_df_error$f_WL_590, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
arrows(x0=f_WL_df$date, y0=f_WL_df$f_WL_660 - f_WL_df_error$f_WL_660, 
       x1=f_WL_df$date, y1=f_WL_df$f_WL_660 + f_WL_df_error$f_WL_660, code=3, angle=90, length=0.1, col="#134467", lwd=1)
arrows(x0=f_WL_df$date, y0=f_WL_df$f_WL_880 - f_WL_df_error$f_WL_880, 
       x1=f_WL_df$date, y1=f_WL_df$f_WL_880 + f_WL_df_error$f_WL_880, code=3, angle=90, length=0.1, col="#0a2a44", lwd=1)
arrows(x0=f_WL_df$date, y0=f_WL_df$f_WL_950 - f_WL_df_error$f_WL_950, 
       x1=f_WL_df$date, y1=f_WL_df$f_WL_950 + f_WL_df_error$f_WL_950, code=3, angle=90, length=0.1, col="#001224", lwd=1)
...
plot(LE_correction_df$date, LE_correction_df$LE_corr_370,
     ...
     xlab = "Time during the experiment",
     ylim = c(-0.25,1.5),
     main = bquote(bold("Loading effect correction -"~R(lambda))),
     col="#00bfff", pch = 20)

points(LE_correction_df$date, LE_correction_df$LE_corr_470, col="#189ed8", pch = 20)
points(LE_correction_df$date, LE_correction_df$LE_corr_520, col="#1c7fb1", pch = 20)
points(LE_correction_df$date, LE_correction_df$LE_corr_590, col="#19618b", pch = 20)
points(LE_correction_df$date, LE_correction_df$LE_corr_660, col="#134467", pch = 20)
points(LE_correction_df$date, LE_correction_df$LE_corr_880, col="#0a2a44", pch = 20)
points(LE_correction_df$date, LE_correction_df$LE_corr_950, col="#001224", pch = 20)

arrows(x0=LE_correction_df$date, y0=LE_correction_df$LE_corr_370 - LE_correction_df_error$LE_corr_370, 
       x1=LE_correction_df$date, y1=LE_correction_df$LE_corr_370 + LE_correction_df_error$LE_corr_370, code=3, angle=90, length=0.1, col="#00bfff", lwd=1)
arrows(x0=LE_correction_df$date, y0=LE_correction_df$LE_corr_470 - LE_correction_df_error$LE_corr_470, 
       x1=LE_correction_df$date, y1=LE_correction_df$LE_corr_470 + LE_correction_df_error$LE_corr_470, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=LE_correction_df$date, y0=LE_correction_df$LE_corr_520 - LE_correction_df_error$LE_corr_520, 
       x1=LE_correction_df$date, y1=LE_correction_df$LE_corr_520 + LE_correction_df_error$LE_corr_520, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=LE_correction_df$date, y0=LE_correction_df$LE_corr_590 - LE_correction_df_error$LE_corr_590, 
       x1=LE_correction_df$date, y1=LE_correction_df$LE_corr_590 + LE_correction_df_error$LE_corr_590, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
arrows(x0=LE_correction_df$date, y0=LE_correction_df$LE_corr_660 - LE_correction_df_error$LE_corr_660, 
       x1=LE_correction_df$date, y1=LE_correction_df$LE_corr_660 + LE_correction_df_error$LE_corr_660, code=3, angle=90, length=0.1, col="#134467", lwd=1)
arrows(x0=LE_correction_df$date, y0=LE_correction_df$LE_corr_880 - LE_correction_df_error$LE_corr_880, 
       x1=LE_correction_df$date, y1=LE_correction_df$LE_corr_880 + LE_correction_df_error$LE_corr_880, code=3, angle=90, length=0.1, col="#0a2a44", lwd=1)
arrows(x0=LE_correction_df$date, y0=LE_correction_df$LE_corr_950 - LE_correction_df_error$LE_corr_950, 
       x1=LE_correction_df$date, y1=LE_correction_df$LE_corr_950 + LE_correction_df_error$LE_corr_950, code=3, angle=90, length=0.1, col="#001224", lwd=1)
...
plot(Babs_df$date, Babs_df$Babs_370,
     ...
     ylab = bquote(beta[abs]~(m^-1)),
     ylim = c(0, 0.0005),
     main = bquote(bold("Absorption coefficient -"~beta[abs](lambda))),
     col="#00bfff", pch = 20)

points(Babs_df$date, Babs_df$Babs_470, col="#189ed8", pch = 20)
points(Babs_df$date, Babs_df$Babs_520, col="#1c7fb1", pch = 20)
points(Babs_df$date, Babs_df$Babs_590, col="#19618b", pch = 20)
points(Babs_df$date, Babs_df$Babs_660, col="#134467", pch = 20)
points(Babs_df$date, Babs_df$Babs_880, col="#0a2a44", pch = 20)
points(Babs_df$date, Babs_df$Babs_950, col="#001224", pch = 20)

arrows(x0=Babs_df$date, y0=Babs_df$Babs_370 - Babs_df_error$Babs_370, 
       x1=Babs_df$date, y1=Babs_df$Babs_370 + Babs_df_error$Babs_370, code=3, angle=90, length=0.1, col="#00bfff", lwd=1)
arrows(x0=Babs_df$date, y0=Babs_df$Babs_470 - Babs_df_error$Babs_470, 
       x1=Babs_df$date, y1=Babs_df$Babs_470 + Babs_df_error$Babs_470, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=Babs_df$date, y0=Babs_df$Babs_520 - Babs_df_error$Babs_520, 
       x1=Babs_df$date, y1=Babs_df$Babs_520 + Babs_df_error$Babs_520, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=Babs_df$date, y0=Babs_df$Babs_590 - Babs_df_error$Babs_590, 
       x1=Babs_df$date, y1=Babs_df$Babs_590 + Babs_df_error$Babs_590, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
arrows(x0=Babs_df$date, y0=Babs_df$Babs_660 - Babs_df_error$Babs_660, 
       x1=Babs_df$date, y1=Babs_df$Babs_660 + Babs_df_error$Babs_660, code=3, angle=90, length=0.1, col="#134467", lwd=1)
arrows(x0=Babs_df$date, y0=Babs_df$Babs_880 - Babs_df_error$Babs_880, 
       x1=Babs_df$date, y1=Babs_df$Babs_880 + Babs_df_error$Babs_880, code=3, angle=90, length=0.1, col="#0a2a44", lwd=1)
arrows(x0=Babs_df$date, y0=Babs_df$Babs_950 - Babs_df_error$Babs_950, 
       x1=Babs_df$date, y1=Babs_df$Babs_950 + Babs_df_error$Babs_950, code=3, angle=90, length=0.1, col="#001224", lwd=1)
...
# re-calculate the loading effect correction (LE_correction)
...
# re-calculate the error related to SSA (Bext error * Bsca (predicted) error)
...
plot(SSA_df_new$date, SSA_df_new$SSA_370,
     ...
     main = bquote(bold("Single scattering albedo - SSA"*(lambda))),
     col="#00bfff", pch = 20)
points(SSA_df_new$date, SSA_df_new$SSA_470, col="#189ed8", pch = 20)
points(SSA_df_new$date, SSA_df_new$SSA_520, col="#1c7fb1", pch = 20)
points(SSA_df_new$date, SSA_df_new$SSA_590, col="#19618b", pch = 20)
points(SSA_df_new$date, SSA_df_new$SSA_660, col="#134467", pch = 20)
points(SSA_df_new$date, SSA_df_new$SSA_880, col="#0a2a44", pch = 20)
points(SSA_df_new$date, SSA_df_new$SSA_950, col="#001224", pch = 20)

arrows(x0=SSA_df_new$date, y0=SSA_df_new$SSA_370 - SSA_df_error_new$SSA_370, 
       x1=SSA_df_new$date, y1=SSA_df_new$SSA_370 + SSA_df_error_new$SSA_370, code=3, angle=90, length=0.1, col="#00bfff", lwd=1)
arrows(x0=SSA_df_new$date, y0=SSA_df_new$SSA_470 - SSA_df_error_new$SSA_470, 
       x1=SSA_df_new$date, y1=SSA_df_new$SSA_470 + SSA_df_error_new$SSA_470, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=SSA_df_new$date, y0=SSA_df_new$SSA_520 - SSA_df_error_new$SSA_520, 
       x1=SSA_df_new$date, y1=SSA_df_new$SSA_520 + SSA_df_error_new$SSA_520, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=SSA_df_new$date, y0=SSA_df_new$SSA_590 - SSA_df_error_new$SSA_590, 
       x1=SSA_df_new$date, y1=SSA_df_new$SSA_590 + SSA_df_error_new$SSA_590, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
arrows(x0=SSA_df_new$date, y0=SSA_df_new$SSA_660 - SSA_df_error_new$SSA_660, 
       x1=SSA_df_new$date, y1=SSA_df_new$SSA_660 + SSA_df_error_new$SSA_660, code=3, angle=90, length=0.1, col="#134467", lwd=1)
arrows(x0=SSA_df_new$date, y0=SSA_df_new$SSA_880 - SSA_df_error_new$SSA_880, 
       x1=SSA_df_new$date, y1=SSA_df_new$SSA_880 + SSA_df_error_new$SSA_880, code=3, angle=90, length=0.1, col="#0a2a44", lwd=1)
arrows(x0=SSA_df_new$date, y0=SSA_df_new$SSA_950 - SSA_df_error_new$SSA_950, 
       x1=SSA_df_new$date, y1=SSA_df_new$SSA_950 + SSA_df_error_new$SSA_950, code=3, angle=90, length=0.1, col="#001224", lwd=1)
...
plot(f_WL_df_new$date, f_WL_df_new$f_WL_370,
     ...
     main = bquote(bold(f(lambda))),
     col="#00bfff", pch = 20, ylim = c(0,1.5))
points(f_WL_df_new$date, f_WL_df_new$f_WL_470, col="#189ed8", pch = 20)
points(f_WL_df_new$date, f_WL_df_new$f_WL_520, col="#1c7fb1", pch = 20)
points(f_WL_df_new$date, f_WL_df_new$f_WL_590, col="#19618b", pch = 20)
points(f_WL_df_new$date, f_WL_df_new$f_WL_660, col="#134467", pch = 20)
points(f_WL_df_new$date, f_WL_df_new$f_WL_880, col="#0a2a44", pch = 20)
points(f_WL_df_new$date, f_WL_df_new$f_WL_950, col="#001224", pch = 20)

arrows(x0=f_WL_df_new$date, y0=f_WL_df_new$f_WL_370 - f_WL_df_error_new$f_WL_370, 
       x1=f_WL_df_new$date, y1=f_WL_df_new$f_WL_370 + f_WL_df_error_new$f_WL_370, code=3, angle=90, length=0.1, col="#00bfff", lwd=1)
arrows(x0=f_WL_df_new$date, y0=f_WL_df_new$f_WL_470 - f_WL_df_error_new$f_WL_470, 
       x1=f_WL_df_new$date, y1=f_WL_df_new$f_WL_470 + f_WL_df_error_new$f_WL_470, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=f_WL_df_new$date, y0=f_WL_df_new$f_WL_520 - f_WL_df_error_new$f_WL_520, 
       x1=f_WL_df_new$date, y1=f_WL_df_new$f_WL_520 + f_WL_df_error_new$f_WL_520, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=f_WL_df_new$date, y0=f_WL_df_new$f_WL_590 - f_WL_df_error_new$f_WL_590, 
       x1=f_WL_df_new$date, y1=f_WL_df_new$f_WL_590 + f_WL_df_error_new$f_WL_590, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
arrows(x0=f_WL_df_new$date, y0=f_WL_df_new$f_WL_660 - f_WL_df_error_new$f_WL_660, 
       x1=f_WL_df_new$date, y1=f_WL_df_new$f_WL_660 + f_WL_df_error_new$f_WL_660, code=3, angle=90, length=0.1, col="#134467", lwd=1)
arrows(x0=f_WL_df_new$date, y0=f_WL_df_new$f_WL_880 - f_WL_df_error_new$f_WL_880, 
       x1=f_WL_df_new$date, y1=f_WL_df_new$f_WL_880 + f_WL_df_error_new$f_WL_880, code=3, angle=90, length=0.1, col="#0a2a44", lwd=1)
arrows(x0=f_WL_df_new$date, y0=f_WL_df_new$f_WL_950 - f_WL_df_error_new$f_WL_950, 
       x1=f_WL_df_new$date, y1=f_WL_df_new$f_WL_950 + f_WL_df_error_new$f_WL_950, code=3, angle=90, length=0.1, col="#001224", lwd=1)
...
points(LE_correction_df_new$date, LE_correction_df_new$LE_corr_470, col="#189ed8", pch = 20)
points(LE_correction_df_new$date, LE_correction_df_new$LE_corr_520, col="#1c7fb1", pch = 20)
points(LE_correction_df_new$date, LE_correction_df_new$LE_corr_590, col="#19618b", pch = 20)
points(LE_correction_df_new$date, LE_correction_df_new$LE_corr_660, col="#134467", pch = 20)
points(LE_correction_df_new$date, LE_correction_df_new$LE_corr_880, col="#0a2a44", pch = 20)
points(LE_correction_df_new$date, LE_correction_df_new$LE_corr_950, col="#001224", pch = 20)

arrows(x0=LE_correction_df_new$date, y0=LE_correction_df_new$LE_corr_370 - LE_correction_df_error_new$LE_corr_370, 
       x1=LE_correction_df_new$date, y1=LE_correction_df_new$LE_corr_370 + LE_correction_df_error_new$LE_corr_370, code=3, angle=90, length=0.1, col="#00bfff", lwd=1)
arrows(x0=LE_correction_df_new$date, y0=LE_correction_df_new$LE_corr_470 - LE_correction_df_error_new$LE_corr_470, 
       x1=LE_correction_df_new$date, y1=LE_correction_df_new$LE_corr_470 + LE_correction_df_error_new$LE_corr_470, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=LE_correction_df_new$date, y0=LE_correction_df_new$LE_corr_520 - LE_correction_df_error_new$LE_corr_520, 
       x1=LE_correction_df_new$date, y1=LE_correction_df_new$LE_corr_520 + LE_correction_df_error_new$LE_corr_520, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=LE_correction_df_new$date, y0=LE_correction_df_new$LE_corr_590 - LE_correction_df_error_new$LE_corr_590, 
       x1=LE_correction_df_new$date, y1=LE_correction_df_new$LE_corr_590 + LE_correction_df_error_new$LE_corr_590, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
arrows(x0=LE_correction_df_new$date, y0=LE_correction_df_new$LE_corr_660 - LE_correction_df_error_new$LE_corr_660, 
       x1=LE_correction_df_new$date, y1=LE_correction_df_new$LE_corr_660 + LE_correction_df_error_new$LE_corr_660, code=3, angle=90, length=0.1, col="#134467", lwd=1)
arrows(x0=LE_correction_df_new$date, y0=LE_correction_df_new$LE_corr_880 - LE_correction_df_error_new$LE_corr_880, 
       x1=LE_correction_df_new$date, y1=LE_correction_df_new$LE_corr_880 + LE_correction_df_error_new$LE_corr_880, code=3, angle=90, length=0.1, col="#0a2a44", lwd=1)
arrows(x0=LE_correction_df_new$date, y0=LE_correction_df_new$LE_corr_950 - LE_correction_df_error_new$LE_corr_950, 
       x1=LE_correction_df_new$date, y1=LE_correction_df_new$LE_corr_950 + LE_correction_df_error_new$LE_corr_950, code=3, angle=90, length=0.1, col="#001224", lwd=1)
...
points(Babs_df_new$date, Babs_df_new$Babs_470, col="#189ed8", pch = 20)
points(Babs_df_new$date, Babs_df_new$Babs_520, col="#1c7fb1", pch = 20)
points(Babs_df_new$date, Babs_df_new$Babs_590, col="#19618b", pch = 20)
points(Babs_df_new$date, Babs_df_new$Babs_660, col="#134467", pch = 20)
points(Babs_df_new$date, Babs_df_new$Babs_880, col="#0a2a44", pch = 20)
points(Babs_df_new$date, Babs_df_new$Babs_950, col="#001224", pch = 20)

arrows(x0=Babs_df_new$date, y0=Babs_df_new$Babs_370 - Babs_df_error_new$Babs_370, 
       x1=Babs_df_new$date, y1=Babs_df_new$Babs_370 + Babs_df_error_new$Babs_370, code=3, angle=90, length=0.1, col="#00bfff", lwd=1)
arrows(x0=Babs_df_new$date, y0=Babs_df_new$Babs_470 - Babs_df_error_new$Babs_470, 
       x1=Babs_df_new$date, y1=Babs_df_new$Babs_470 + Babs_df_error_new$Babs_470, code=3, angle=90, length=0.1, col="#189ed8", lwd=1)
arrows(x0=Babs_df_new$date, y0=Babs_df_new$Babs_520 - Babs_df_error_new$Babs_520, 
       x1=Babs_df_new$date, y1=Babs_df_new$Babs_520 + Babs_df_error_new$Babs_520, code=3, angle=90, length=0.1, col="#1c7fb1", lwd=1)
arrows(x0=Babs_df_new$date, y0=Babs_df_new$Babs_590 - Babs_df_error_new$Babs_590, 
       x1=Babs_df_new$date, y1=Babs_df_new$Babs_590 + Babs_df_error_new$Babs_590, code=3, angle=90, length=0.1, col="#19618b", lwd=1)
arrows(x0=Babs_df_new$date, y0=Babs_df_new$Babs_660 - Babs_df_error_new$Babs_660, 
       x1=Babs_df_new$date, y1=Babs_df_new$Babs_660 + Babs_df_error_new$Babs_660, code=3, angle=90, length=0.1, col="#134467", lwd=1)
arrows(x0=Babs_df_new$date, y0=Babs_df_new$Babs_880 - Babs_df_error_new$Babs_880, 
       x1=Babs_df_new$date, y1=Babs_df_new$Babs_880 + Babs_df_error_new$Babs_880, code=3, angle=90, length=0.1, col="#0a2a44", lwd=1)
arrows(x0=Babs_df_new$date, y0=Babs_df_new$Babs_950 - Babs_df_error_new$Babs_950, 
       x1=Babs_df_new$date, y1=Babs_df_new$Babs_950 + Babs_df_error_new$Babs_950, code=3, angle=90, length=0.1, col="#001224", lwd=1)
